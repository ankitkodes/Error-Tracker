...
export default function Footer() {
  ...
  return (
    <footer className="w-full font-sans text-[#d5d5d5] bg-transparent">
      ...
      <div className="px-4 py-10 md:py-12 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
              ...
              {isSubscribed ? (
                ...
                <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-2.5">
                  <input
                    ...
                    className="w-full h-10 rounded-lg bg-[#0a0a0a] border border-[#202026] px-3.5 text-sm text-white placeholder:text-[#666] focus:outline-none focus:ring-2 focus:ring-[#00ffb2]/50 focus:border-[#00ffb2] transition"
                  />
                  <button
                    type="submit"
                    className="h-10 rounded-lg bg-[#00ffb2] hover:bg-[#00e6a0] text-black font-semibold text-sm px-4 transition-colors duration-200 cursor-pointer shadow-md shrink-0 flex items-center justify-center gap-1.5"
                  >
                    <span>Subscribe</span>
          ...
          {/* Nav Columns Wrapper */}
          <div className="md:col-span-6 lg:col-span-6 grid grid-cols-2 gap-8 sm:gap-12">
            {/* Column 2: Product */}
            <div>
              <p className="text-base font-semibold text-white mb-4">Product</p>
              <nav aria-label="Product Links">
                <ul className="flex flex-col gap-2.5 text-sm md:text-base">
                  ...
                  <li>
                    <Link href="/blog" className="hover:text-[#00ffb2] transition-colors duration-200 inline-block">
                      Blog
                    </Link>
                  </li>
                </ul>
            ...
            {/* Column 3: Social */}
            <div>
              <p className="text-base font-semibold text-white mb-4">Social</p>
                ...
                <ul className="flex flex-col gap-2.5 text-sm md:text-base">
                  ...
                  <li>
                    <a
                      ...
                      className="group flex items-center gap-2.5 hover:text-[#00ffb2] transition-colors duration-200"
                    >
                      <FaXTwitter className="w-4 h-4 text-gray-400 group-hover:text-[#00ffb2] transition-colors" />
                      <span>Twitter (X)</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      className="group flex items-center gap-2.5 hover:text-[#00ffb2] transition-colors duration-200"
                    >
                      <FaLinkedin className="w-4 h-4 text-gray-400 group-hover:text-[#00ffb2] transition-colors" />
                      <span>LinkedIn</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      className="group flex items-center gap-2.5 hover:text-[#00ffb2] transition-colors duration-200"
                    >
                      <FaDiscord className="w-4 h-4 text-gray-400 group-hover:text-[#00ffb2] transition-colors" />
                      <span>Discord</span>
                    </a>
                  </li>
                </ul>
        ...
        <div className="border-t border-[#202026] mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs sm:text-sm text-gray-400">
          <p>© 2026 BugTrace. All rights reserved.</p>
          <div className="flex items-center gap-6">
            <button
              onClick={() => setPrivacyModalOpen(true)}
              className="hover:text-[#00ffb2] transition-colors duration-200 cursor-pointer text-left"
            >
              Privacy Policy
            </button>
            <button
